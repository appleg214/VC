...
CLoadImageDlg::CLoadImageDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CLoadImageDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CLoadImageDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CLoadImageDlg::OnBnClickedOk)
END_MESSAGE_MAP()
...
void CLoadImageDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CLoadImageDlg::OnBnClickedOk()
{
