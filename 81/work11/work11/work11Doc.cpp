...
// work11Doc.cpp : CDocViewPrintDoc 类的实现
//
...
// 缩略图的支持
void CDocViewPrintDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CDocViewPrintDoc::InitializeSearchContent()
{
...
void CDocViewPrintDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
